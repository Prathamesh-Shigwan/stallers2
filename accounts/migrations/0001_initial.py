    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'User'), ('staff', 'Staff'), ('content_manager', 'Content Manager'), ('inventory_manager', 'Inventory Manager'), ('finance_manager', 'Finance Manager'), ('admin', 'Admin')], default='user', max_length=20)),
